...
g = Game()
platform1 = PlatformSprite(g, PhotoImage(file="platform1.gif"), 0, 450, 100, 10)
platform2 = PlatformSprite(g, PhotoImage(file="platform1.gif"), 150, 400, 100, 10)
...
platform6 = PlatformSprite(g, PhotoImage(file="platform2.gif"), 100, 300, 66, 10)
