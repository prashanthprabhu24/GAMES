...
class MovingPlatformSprite(PlatformSprite):
    def __init__(self, game, photo_image, x, y, width, height):
        ...
        self.x = random.choice([-1,-2,-3,1,2,3,0])
        self.counter = 0
...
g = Game()
platform1 = MovingPlatformSprite(g, PhotoImage(file="platform1.gif"), 0, 450, 100, 10)
platform2 = MovingPlatformSprite(g, PhotoImage(file="platform1.gif"), 150, 400, 100, 10)
platform3 = MovingPlatformSprite(g, PhotoImage(file="platform1.gif"), 300, 400, 100, 10)
platform4 = MovingPlatformSprite(g, PhotoImage(file="platform1.gif"), 300, 160, 100, 10)
platform5 = MovingPlatformSprite(g, PhotoImage(file="platform2.gif"), 175, 350, 66, 10)
platform6 = MovingPlatformSprite(g, PhotoImage(file="platform2.gif"), 100, 300, 66, 10)
...
platform10 = MovingPlatformSprite(g, PhotoImage(file="platform3.gif"), 230, 200, 32, 10)
